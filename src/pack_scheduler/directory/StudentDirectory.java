...
public class StudentDirectory {
	...
	/**
	 * Gives the student directory in the form of a sorted list
	 * @return the student directory in a sorted list
	 */
	public SortedList<Student> getStudentDirectoryList() {
	...
	/**
	 * return a student by searching for their id
	 * Gives a student when their id is given
	 * if no id is given, returns null
	 * @param id the id number to search the studentDirectory for
	 * @return a student if their id is found, null otherwise
	 */
