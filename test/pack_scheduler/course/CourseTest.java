...
public class CourseTest {
    ...
    /** number of students that can enroll in a course */
    ...
    /**
     * tests that compareTo is sorting in the correct order
     */
    @Test
    public void testCompareTo() {
        ...
        Course c5 = new Course("SOC202", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
        ...
        assertEquals(c5.compareTo(c6), 1);
    }
}